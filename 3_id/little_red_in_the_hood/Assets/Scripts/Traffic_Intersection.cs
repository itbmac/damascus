...
public class Traffic_Intersection : MonoBehaviour {
	...
	public Traffic_Light.lightColor colorPos2n4;
	...
	void Start () {
		...
		L4 = light4.GetComponent("Traffic_Light") as Traffic_Light;
	...
	void FixedUpdate () {
		if (!startSet) {
			...
			L2.SetLightColor(colorPos2n4);
			L3.SetLightColor(colorPos1n3);
			L4.SetLightColor(colorPos2n4);
			startSet = true;
		}
...
//			}
//
//			if (L4.trafficLightColor == Traffic_Light.lightColor.RED) {
//				L4.SetColliderState(true);
//			}
//		}
//	}
}
